      ...
      {!ctx.submitted ? (
        <>
          ...
          {store.showPrevious ? (
            ...
            <>
              <label for="docs" class="btn btn-secondary w-full sm:w-auto gap-2">
                <svg class="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                  <path d="M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-144c-17.7 0-32-14.3-32-32s14.3-32 32-32s32 14.3 32 32s-14.3 32-32 32z" />
                </svg>
                Anleitung
              </label>
              <input type="checkbox" id="docs" className="modal-toggle" />
              <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                  <h3 className="font-bold text-lg">Hallo, zufälliger Internetnutzer!</h3>
                  <p className="font-normal pt-4">
                    Das Quiz hat insgesamt 30 Fragen, aus denen beim Start 10 ausgewählt werden. Wenn alle Fragen richtig beantwortet wurden, gibt es am Ende
                    ein kleines Geschenk.
                  </p>
                  <p className="font-normal py-2">Tipp: Der Schneefall kann ausgeschaltet werden.</p>
                  <div className="modal-action">
                    <label for="docs" className="btn btn-primary">
                      Los gehts!
                    </label>
                  </div>
                </div>
